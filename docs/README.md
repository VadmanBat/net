...
| [tcp-server.md](classes/tcp-server.md) 🖥️ | `TcpServer` |
| [file-transfer.md](classes/file-transfer.md) 📁 | передача файла |
| [net-initializer.md](classes/net-initializer.md) ⚙️ | Winsock init |
...
`tests/loopback/` (CTest `net-loopback`), только top-level.
